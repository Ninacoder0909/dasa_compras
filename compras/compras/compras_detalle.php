            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <?php } ?>
                        <!-- MENSAJE -->
                        <h3 style="text-align: center">Compras - Detalle</h3>
                        <!--CABECERA-->
                        <div class="box box-primary" style="border-width: 30px">
                            <div class="box-header">
                                ...
                                $confirmar = consultas::get_datos("SELECT * FROM v_compras_detalle WHERE id_compra = $idpedido");
                                if (!empty($confirmar)) {
                                ?>
                                    <?php foreach ($confirmar as $con) { ?>
                                    <?php } ?>
                                    <?php if ($con['estado'] == 'ACTIVO') { ?>
                                        <a style="padding: 10px; margin: 1px" data-toggle="modal" data-target="#confirmar" onclick="registrar_confirmacion(<?php echo "'" . $_REQUEST['vidcompra'] . "'" ?>);" class="btn btn-toolbar btn-lg" role="button" rel="tooltip" data-title="Confirmar" rel="tooltip" data-placement="top">
                                ...
                                <div class="box-tools">
                                    ...
                                    <?php
                                    $idpe = $_REQUEST['vidcompra'];
                                    $anular = consultas::get_datos("SELECT * FROM v_compras WHERE id_compra = $idpe");
                                    ...
                                    ?>
                                        ...
                                        <?php if ($an['estado'] == 'CONFIRMADO') { ?>
                                            <a data-toggle="modal" data-target="#anular" onclick="anulacion(<?php echo "'" . $_REQUEST['vidcompra'] . "'" ?>);" class="btn btn-toolbar btn-lg pull-right" role="button" rel="tooltip" data-title="Anular" rel="tooltip" data-placement="top">
                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <?php
                                        $idpedido = $_REQUEST['vidcompra'];
                                        $compras = consultas::get_datos("SELECT * FROM v_compras WHERE id_compra = $idpedido ");
                                        if (!empty($compras)) {
                                        ?>
                                                ...
                                                <table class="table col-lg-12 col-md-12 col-xs-12">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($compras as $pc) {
                                                            $total = consultas::get_datos("SELECT sum(cantidad*precio) as total FROM v_compras_detalle where id_compra=$pc[id_compra]");
                                                            if ($total !== false && isset($total[0]['total'])) {
                                                                $resultado = $total[0]['total'];
                                                            } else {
                                                                $resultado = 0;
                                                            }
                                                            $totaliva = consultas::get_datos("SELECT sum(iva5 + iva10 + exentas) as total FROM v_compras_detalle where id_compra=$pc[id_compra]");
                        ...
                        <div class="box box-primary" style="border-width: 30px">
                            ...
                            <div class="box-body no-padding">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    <?php
                                    $idpedido = $_REQUEST['vidcompra'];
                                    $comprasdetalle = consultas::get_datos("SELECT * FROM v_compras_detalle WHERE id_compra = $idpedido");
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-btn">
                                                                        <button class="btn btn-primary btn-flat btn-l" style="height: 33px;" type="button" data-toggle="modal" data-target="#registrar_producto">
...
<script>
    ...
    function registrar_confirmacion(datos) {
        ...
        $.ajax({
            type: "GET",
            url: "/dasa_compras/compras/compras/compras_confirmar.php?vidcompra=" + dat[0],
            beforeSend: function() {
...
<script>
    function anulacion(datos) {
        ...
        $.ajax({
            type: "GET",
            url: "/dasa_compras/compras/compras/compras_anular.php?vidcompra=" + dat[0],
            beforeSend: function() {
