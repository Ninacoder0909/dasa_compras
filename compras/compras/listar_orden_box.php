...
$productos = consultas::get_datos("SELECT * FROM v_orden_de_compra WHERE estado = 'CONFIRMADO' AND prv_cod = " . $idproducto);
?>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4 col-sm-4 col-xs-4">
            <select class="form-control" name="vidorden" id="pedido" onchange="obtenerord();ver_boton_registrar()" onclick="obtenerord();ver_boton_registrar()">
                ...
                ?>
                        <option value="<?php echo $m['id_ordenc']; ?>"><?php echo $m['id_ordenc']; ?><?php echo ' | '; ?><?php echo $m['fecha']; ?></option>
                    <?php
                    }
                } else {
                    ?>
