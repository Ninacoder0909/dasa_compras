                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box_primary" style="background-color: white">
                                ...
                                <form action="ncredito_control.php" method="POST" accept-charset="UTF-8"
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php $compras = consultas::get_datos("SELECT COALESCE(MAX(id_credito),0)+1 AS ultimo FROM nota_credito;") ?>
                                            ...
                                            <div class="form-group"  id="pedis" >
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <?php $marcas = consultas::get_datos("SELECT * FROM motivo where id_motivo > 2 ORDER BY id_motivo"); ?>
                                                    <select class="form-control"  name="vmotivo" required=""  >
                                                        ...
                                                        if (!empty($marcas)) {
                                                            foreach ($marcas as $m) {
                                                                ?>
                                                                <option  value="<?php echo $m['id_motivo']; ?>"><?php echo $m['descripcion']; ?></option>
                                                                <?php
                                                            }
                                                        } else {
                                                            ?>
    ...
    <script>
        ...
        function obtenerord() {
            ...
            if (parseInt($('#pedido').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/dasa_compras/compras/nota_debito/listar_compra.php?vidcompra=" + dat[0], cache: false,
                    beforeSend: function () {
