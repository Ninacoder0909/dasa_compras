...
<div class="panel-body">
    <form action="ncredito_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
        <div class="panel-body se">
            <div class="row">
                <?php $resultado = consultas::get_datos("SELECT * FROM v_ncredito WHERE id_credito =" . $_REQUEST['vidcredito']); ?>
                <div class="form-group">
                    <h4 class="modal-title" style="text-align: center;"><strong>¿Desea anular la Nota de Credito N° <?php echo ' ' . $resultado[0]['id_credito']; ?>?</strong></h4>
                    ...
                    <input class="form-control" type="hidden" name="vncredito" value="<?php echo $resultado[0]['id_credito']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6 col-sm-4 col-xs-4">
                        <input style="padding: 8px" class="form-control" type="password" maxlength="3" pattern="[0-9]{3}" title="Codigo erroneo" name="vidcompra" required="">
                    </div>
                </div>
