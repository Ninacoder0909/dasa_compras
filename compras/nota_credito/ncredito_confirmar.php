...
<div class="panel-body">
    ...
    <form action = "ncredito_control.php" method = "post" accept-charset = "utf-8" class = "form-horizontal">
            ...
            <h4 class = "modal-title" style="text-align: center"><strong>¿Desea confirmar la Nota de Credito N° <?php echo $gru ?> ?</strong></h4>
            <input name="voperacion" value="2" type="hidden">
            <input class="form-control" name="vncredito" type="hidden" value="<?php echo $gru ?>"  readonly="" id="codigo" onkeypress="return soloNum(event)" required="">  
