                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            if (!empty($pedidos)) {
                                        ...
                                        if (!empty($confirmar)) {
                                            ...
                                            <?php if ($con['estado'] == 'ACTIVO') { ?>
                                                <a style="padding: 10px; margin: 1px"  data-toggle="modal" data-target="#confirmar"
                                                   onclick="registrar_confirmacion(<?php echo "'" . $_REQUEST['vidcredito'] . "'" ?>);"
                                        ...
                                        <div class="box-tools">
                                            ...
                                            if (!empty($anular)) {
                                                ...
                                                <?php if ($an['estado'] == 'CONFIRMADO' && $an['fecha_anu'] = $fe['fechap']) { ?>
                                                    <a  data-toggle="modal" data-target="#anular"
                                                        onclick="anulacion(<?php echo "'" . $_REQUEST['vidcredito'] . "'" ?>);"
                                                        class="btn btn-toolbar btn-lg pull-right" role="button" rel="tooltip"  data-title="Anular" rel="tooltip" data-placement="top">
                                ...
                                <!-- CABECERA SI ES CON PEDIDO -->
                                <!-- DETALLE DE ORDEN -->
                                <div class="box box-primary" style="border-width: 5px">
                                    <div class="box-header">
                                        <i class="ion ion-clipboard"></i>
                                    ...
                                    <div class="box-body no-padding">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <?php
                                            $idpedido = $_REQUEST['vidcredito'];
                                            $ordenpedido = consultas::get_datos("SELECT * FROM v_compras WHERE id_compra = (select id_compra from nota_credito WHERE id_credito =" . $_REQUEST['vidcredito'] . ")");
                                            if (!empty($ordenpedido)) {
                                                $idpedido = $_REQUEST['vidcredito'];
                                                $compradet = consultas::get_datos("select * from v_compras_detalle where id_compra = (select id_compra from nota_credito WHERE id_credito =" . $_REQUEST['vidcredito'] . ") ");
                                                if (!empty($compradet)) {
                                                    ?>
                                                    <div class="table-responsive">
                                                        <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered">
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($compradet AS $op) { ?>
                                                                    <tr>
                                                                        <td class="text-center"> <?php echo $op['pro_descri']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['dep_descri']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['cantidad']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['precio']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['subtotal']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['iva5']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['iva10']; ?></td>
                                                                        <td class="text-center"> <?php echo $op['exentas']; ?></td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <?php } else { ?>
                                                <div class="alert alert-danger flat">
                                                    <span class="glyphicon glyphicon-info-sign"></span> La nota  no tiene pedido...
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <div class="box box-primary" style="border-width: 30px">
                                    ...
                                    <div class="box-body no-padding">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <?php
                                            $idpedido = $_REQUEST['vidcredito'];
                                            $pedidoscdetalle = consultas::get_datos("SELECT * from v_ncredito_detalle WHERE id_credito = $idpedido");
                                                            ...
                                                            <?php foreach ($pedidoscdetalle AS $pcd) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <?php if ($pc['estado'] == 'ACTIVO') { ?>
                                                                            <a onclick="quitar(<?php echo "'" . $pcd['id_credito'] . "_" . $pcd['pro_cod'] . "_" . $pcd['id_depo'] . "'"; ?>);"
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($pedidosorden AS $pord) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <?php if ($oc['estado'] == 'ACTIVO') { ?>
                                                                            <a onclick="quitar(<?php echo "'" . $_REQUEST['vidcredito'] . "_" . $pord['pro_cod'] . "_" . $pord['id_depo'] . "'"; ?>);"
                                                                               class="btn btn-danger btn-sm" role="button" data-title="Quitar"
                                                                               rel="tooltip" data-placement="top" data-toggle="modal" data-target="#quitar">
                                                                                <i class="fa fa-times"></i>
                                                                            </a>
                                                                            <a onclick="editar(<?php echo "'" . $_REQUEST['vidcredito'] . "_" . $pord['pro_cod'] . "_" . $pord['id_depo'] . "_" . $pord['cantidad'] . "_" . $pord['precio'] . "'"; ?>)" class="btn btn-lg btn-toolbar" role="button" data-title="Modificar Precio" data-placement="top" rel="tooltip" data-toggle="modal" data-target="#editar">
                            ...
                            <div class="box box-primary" style="width: 550px; height: 365px;margin: 0 auto;border-width: 30px">
                                <div class="box-header">
                                    <i class="ion ion-clipboard"></i>
                                                    ...
                                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <?php $productos = consultas::get_datos("SELECT * FROM v_compras_detalle where id_compra = (SELECT id_compra from nota_credito where id_credito = " .$_REQUEST['vidcredito']." )") ?>
                                                        ...
                                                        <div class="form-group" id="precio">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="number" name="vprecio" class="form-control" readonly=""
                                                                       min="0" value="0" max="10000000" onkeypress="return soloNUM(event)" style="width: 300px;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-6 col-sm-6 col-md-6 col-xs-6">Cantidad</label>
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="number" name="vcantidad"  onkeypress="return soloNUM(event)"  id="idcantidad" class="form-control" required=""
                                                                       onchange="calsubtotal();" max="1000" onkeydown="calsubtotal();"  min="0" value="1" style="width: 300px;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                                <label class="control-label col-lg-6 col-sm-6 col-md-6 col-xs-6">Subtotal</label>
                                                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                    <input type="text" name="vsubtotal" class="form-control"
                                                                           min="0" value="0" id="idsubtotal" readonly="" style="width: 300px;">
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
    ...
    <SCRIPT>
        ...
        function obtenerprecio() {
            ...
            if (parseInt($('#idproducto').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/dasa_compras/compras/nota_credito/listar_precios.php?vidproducto=" + dat[0], cache: false,
                    beforeSend: function () {
