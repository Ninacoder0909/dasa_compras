                                ...
                                <div class="box-body no-padding" >
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            $ncredito= consultas::get_datos("SELECT * FROM v_ncredito WHERE (id_credito||TRIM(UPPER(factu))) LIKE TRIM(UPPER('%" . $valor . "%')) ORDER BY id_credito");
                                                            ...
                                                            <?php foreach ($ncredito AS $p) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="border: black solid thin;" data-title="Acciones" class="text-center">
                                                                        ...
                                                                        <a href="ncredito_detalle.php?vidcredito=<?php echo $p['id_credito']; ?>" 
