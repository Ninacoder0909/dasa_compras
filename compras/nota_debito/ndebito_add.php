                            ...
                            <form action="ndebito_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Cod. Nota debito</label>
                                            <?php $compras = consultas::get_datos("SELECT COALESCE(MAX(id_debito),0)+1 AS ultimo FROM n_deb;") ?>
                                            <div class="col-xs-8 col-sm-4 col-xs-4 ">
                                                <input class="form-control" type="text" name="vndebito" readonly="" value="<?php echo $compras[0]['ultimo']; ?>" required="">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Fecha Nota Debito</label>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <input class="form-control" type="date" name="vfechareci" max="<?php echo date("Y-m-d"); ?>" min="<?php echo date("2022-01-01"); ?>" value="<?php echo date("Y-m-d"); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <?php $marcas = consultas::get_datos("SELECT * FROM motivo_nota where tipo_nota = 'NOTA DEBITO' "); ?>
