                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="box box-primary" style="border-width: 30px">
                            <div class="box-header">
                                ...
                                <?php } ?>
                                <div class="box-tools">
                                    <a href="ndebito_index.php" class="btn btn-primary pull-right btn-sm">
                                        <i class="fa fa-arrow-left"></i>
                                    </a>
                                    <?php
                                    $idpe = $_REQUEST['viddebito'];
                                    $anular = consultas::get_datos("SELECT * FROM v_ndebito WHERE id_debito = $idpe");
                                                ...
                                                <table class="table col-lg-12 col-md-12 col-xs-12">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($compras as $pc) {
                                                            $total = consultas::get_datos("SELECT sum(canti*precio) as total FROM v_ndebito_detalle where id_debito=$pc[id_debito]");
                                                            if ($total !== false && isset($total[0]['total'])) {
                                                                $resultado = $total[0]['total'];
                                                            } else {
                                                                $resultado = 0;
                                                            }
                                                            $totaliva = consultas::get_datos("SELECT sum(iva5 + iva10 + exentas) as total FROM v_ndebito_detalle where id_debito=$pc[id_debito]");
                        ...
                        <div class="box box-primary" style="border-width: 30px">
                            ...
                            <div class="box-body no-padding">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    <?php
                                    $idpedido = $_REQUEST['viddebito'];
                                    $comprasdetalle = consultas::get_datos("SELECT * FROM v_ndebito_detalle WHERE id_debito = $idpedido");
                                                ...
                                                <tbody>
                                                    <?php foreach ($comprasdetalle as $pcd) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"> <?php echo $pcd['canti'] * $pcd['precio']; ?></td>
                                            ...
                                            <form action="ndebito_detalle_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                                <div class="box-body">
                                                    ...
                                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-6 col-sm-6 col-md-6 col-xs-6">canti</label>
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="number" name="vcanti" onkeypress="return soloNUM(event)" id="idcanti" class="form-control" required="" onchange="calsubtotal();" onkeydown="calsubtotal();" min="0" value="1" max="1000" style="width: 300px;">
                                                            </div>
                                                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="marca_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                            ...
                            <input type="hidden" name="viddebito" value="<?php echo $_REQUEST['viddebito']; ?>" id="viddebito">
                            <div class="box-body">
                                <div class="form-group">
...
<SCRIPT>
    ...
    function quitar(datos) {
        ...
        $('#si').attr('href', 'ndebito_detalle_control.php?viddebito=' + dat[0] + '&vproducto=' + dat[1] + '&voperacion=2');
