...
<div class="panel-body">
    ...
    <form action = "nremision_control.php" method = "post" accept-charset = "utf-8" class = "form-horizontal">
            ...
            <h4 class = "modal-title" style="text-align: center"><strong>¿Desea confirmar la Nota de Remision N° <?php echo $gru ?> ?</strong></h4>
            <input name="voperacion" value="2" type="hidden">
            <input class="form-control" name="vnremision" type="hidden" value="<?php echo $gru ?>"  readonly="" id="codigo" onkeypress="return soloNum(event)" required="">  
