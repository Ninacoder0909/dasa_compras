                                        ...
                                        if (!empty($confirmar)) {
                                            ...
                                            <?php if ($con['estado'] == 'ACTIVO') { ?>
                                                <a style="padding: 10px; margin: 1px"  data-toggle="modal" data-target="#confirmar"
                                                   onclick="registrar_confirmacion(<?php echo "'" . $_REQUEST['vidremision'] . "'" ?>);"
                                            ...
                                            if (!empty($anular)) {
                                                ...
                                                <?php if ($an['estado'] == 'CONFIRMADO' && $an['fecha_anu'] = $fe['fechap']) { ?>
                                                    <a  data-toggle="modal" data-target="#anular"
                                                        onclick="anulacion(<?php echo "'" . $_REQUEST['vidremision'] . "'" ?>);"
                                                        ...
                                                        <table class="table col-lg-12 col-md-12 col-xs-12">
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($compras AS $pc) { ?>
                                                                    ...
                                                                    <td class="text-center" data-title="Producto "> <?php echo $p['suc_destino'] ?></td>
                                                                    <td class="text-center" data-title="Deposito "> <?php echo $p['nombres'] ?></td>
                                                                    <td class="text-center" data-title="Cantidad "> <?php echo $p['auto'] ?></td>
                                                                    <td class="text-center" data-title="Deposito "> <?php echo $p['fecha_inicio_traslado'] ?></td>
                                                                    <td class="text-center" data-title="Cantidad "> <?php echo $p['estado'] ?></td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
                                                        </table>
                                ...
                                <div class="box box-primary" style="border-width: 30px">
                                    ...
                                    <div class="box-body no-padding">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <?php
                                            $idpedido = $_REQUEST['vidremision'];
                                            $pedidoscdetalle = consultas::get_datos("SELECT * from v_nremision_detalle WHERE id_remision = $idpedido");
                                                            ...
                                                            <?php foreach ($pedidoscdetalle AS $pcd) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <?php if ($pc['estado'] == 'ACTIVO') { ?>
                                                                            <a onclick="quitar(<?php echo "'" . $pcd['id_remision'] . "_" . $pcd['pro_cod'] . "_" . $pcd['id_depo'] . "'"; ?>);"
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($pedidosorden AS $pord) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"> 
                                                                        <?php if ($oc['estado'] == 'ACTIVO') { ?>
                                                                            <a onclick="quitar(<?php echo "'" . $_REQUEST['vidremision'] . "_" . $pord['pro_cod'] . "_" . $pord['id_depo'] . "'"; ?>);"
                                                                               class="btn btn-danger btn-sm" role="button" data-title="Quitar"
                                                                               rel="tooltip" data-placement="top" data-toggle="modal" data-target="#quitar">
                                                                                <i class="fa fa-times"></i>
                                                                            </a>
                                                                            <a onclick="editar(<?php echo "'" . $_REQUEST['vidremision'] . "_" . $pord['pro_cod'] . "_" . $pord['id_depo'] . "_" . $pord['cantidad'] . "_" . $pord['precio'] . "'"; ?>)" class="btn btn-lg btn-toolbar" role="button" data-title="Modificar Precio" data-placement="top" rel="tooltip" data-toggle="modal" data-target="#editar">
    ...
    <SCRIPT>
        ...
        function obtenerprecio() {
            ...
            if (parseInt($('#idproducto').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/dasa_compras/compras/nota_remision/listar_precios.php?vidproducto=" + dat[0], cache: false,
                    beforeSend: function () {
