            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <?php } ?>
                        <!-- MENSAJE -->
                        <h3 style="text-align: center">Pedidos de Compras - Detalle</h3>
                        <!--CABECERA-->
                        <div class="box box-primary" style="border-width: 30px">
                            <div class="box-header">
                                ...
                                $confirmar = consultas::get_datos("SELECT * FROM v_compras_pedidos WHERE id_pedido = $idpedido");
                                if (!empty($confirmar)) {
                                ?>
                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <?php
                                        $idpedido = $_REQUEST['vidpedido'];
                                        $pedidosc = consultas::get_datos("SELECT * FROM v_compras_pedidos WHERE id_pedido = $idpedido ");
                                        if (!empty($pedidosc)) {
                                        ?>
                                                    ...
                                                    <?php foreach ($pedidoscdetalle as $pcd) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($pc['estado'] == 'ACTIVO') { ?>
                                                                    <a onclick="quitar(<?php echo "'" . $pcd['id_pedido'] . "_" . $pcd['pro_cod'] . "'"; ?>);" class="btn btn-danger btn-sm" role="button" data-title="Quitar" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#quitar">
