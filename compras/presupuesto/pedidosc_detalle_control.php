...
if ($resultado[0]['presup'] != NULL) {
    ...
    header("location:presupuesto_detalle.php?vidpedido=". $_REQUEST['vidpresupuesto']);
} else {
    $_SESSION['mensaje'] = 'Error:' . $sql;
    header("location:p_detalle.php?vidpedido=" .$_REQUEST['vidpresupuesto'] + "&vpre=" .$_REQUEST['vidped'] );
}