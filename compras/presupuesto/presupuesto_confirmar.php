...
if (isset($_REQUEST['vidpresupuesto'])) {
...
<div class="panel-body">
    <form action = "presupuesto_detalle_control.php" method = "post" accept-charset = "utf-8" class = "form-horizontal">
        <div class = "panel-body se">
            <h4 class = "modal-title" style="text-align: center"><strong>¿Desea confirmar el presupuesto N° <?php echo $gru ?>?</strong></h4>
            <input name="voperacion" value="3" type="hidden">
            <input class="form-control" name="vidpresupuesto" type="hidden" value="<?php echo $gru ?>"  readonly="" id="codigo" onkeypress="return soloNum(event)" required="">  
