...
//CONSULTA DE DATOS 
$sqls = consultas::get_datos("SELECT * FROM v_stock ORDER BY id_depo");
foreach ($sqls AS $sql){
    $pdf->Cell(25, 5, $sql['pro_cod'], 1, 0, 'C',1);
    $pdf->Cell(70, 5, $sql['pro_descri'], 1, 0, 'C',1);
    $pdf->Cell(50, 5, $sql['dep_descri'], 1, 0, 'C',1);
     $pdf->Cell(40, 5, $sql['st_cantidad'], 1, 0, 'C',1);
    $pdf->Ln();
}
//Salida al navegador
