                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="box box-primary">
                                ...
                                <form action="paginas_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                    <div class="box-body">
                                        <?php $resultado = consultas::get_datos("SELECT * FROM v_paginas WHERE pag_cod =" . $_GET['vid_paginas']); ?>
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" name="vnombre" required="" disabled="" value="<?php echo $resultado[0]['pag_nombre']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                 <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Modulo</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" name="vmol" required="" disabled="" value="<?php echo $resultado[0]['mod_nombre']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
