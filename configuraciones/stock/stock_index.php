                                ...
                                <div class="box-body no-padding" >
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                            <div class="input-group custom-search-form">
                                                                <input type="search" class="form-control" name="buscar" 
                                                                       placeholder="Buscar por deposito/producto..." autofocus=""/>
                                            ...
                                            $stock = consultas::get_datos("SELECT * FROM v_stock WHERE (UPPER(dep_descri)||TRIM(UPPER(pro_descri))) LIKE TRIM(UPPER('%" . $valor . "%')) ORDER BY pro_cod");
                                            if (!empty($stock)) {
                                                ?>
