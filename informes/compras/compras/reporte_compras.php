...
<html>
    ...
    <form accept-charset="UTF8" class="form-horizontal">
        ...
        <div class="col-md-6 col-md-offset-0">
            <div class="list-group">
                <a href="#" class="list-group-item active" style="background-color: #ABD3D1;color: black;padding: 13px;text-align: center;font-size: 20px">INFORMES DE COMPRAS</a>
            </div>
    ...
    <script>
        function obtener_fecha() {
            $.ajax({
                type: 'POST',
                url: "/dasa_compras/informes/compras/compras/fecha.php",
                cache: false,
                beforeSend: function () {
        ...
        function obtener_estado() {
            $.ajax({
                type: 'POST',
                url: "/dasa_compras/informes/compras/compras/estado.php",
                cache: false,
                beforeSend: function () {
                    $('#cargando').html('<img src="/dasa_compras/img/sistema/ajax-loader.gif"><strong><i>En proceso...</i></strong>');
                },
