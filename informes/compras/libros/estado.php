...
<form accept-charset="UTF8" class="form-horizontal">
    ...
    <div class="col-md-6 col-md-offset-0" style=" margin-top: -14px; border: none;">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item active"  style="background-color: #ABD3D1;color: black;text-align: center;font-size: 20px">Informes de Libros por Estado</a>
        </div>
...
<script>
    function enviar() {
        window.open("/dasa_compras/informes/compras/libros/libros_print.php?vciudad=" + "'" + $('#vestado').val() + "'" + '&vopcion=' + $('#opcion').val(), '_blank');
