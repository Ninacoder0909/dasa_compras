...
<form accept-charset="UFT8" class="form-horizontal" onsubmit="return showValues();">
    ...
    <div class="col-md-8 col-md-offset-0" style=" margin-top: -14px; border: none;">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item active" style="background-color: #ABD3D1;color: black;text-align: center;font-size: 20px">Informes de Nota Debito por Fecha</a>
        </div>
...
<script>
    function enviar() {
        window.open("/dasa_compras/informes/compras/ndebito/ndebito_print.php?vdesde=" + "'" + $('#iddesde').val() + "'" + "&vhasta=" + "'" + $('#idhasta').val() + "'" + "&vopcion=" + $('#opcion').val(), '_blank');
    }
</script>
<script>
//     function hasta() {
