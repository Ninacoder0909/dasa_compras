...
<form accept-charset="UFT8" class="form-horizontal" onsubmit="return showValues();">
    ...
    <div class="col-md-8 col-md-offset-0" style=" margin-top: -14px; border: none;">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item active" style="background-color: #ABD3D1;color: black;text-align: center;font-size: 20px">Informes de Presupuesto por Fecha</a>
        </div>
        ...
        <div class="form-group col-md-8">
            <div class="col-md-1 pull-right">
                <a onclick="enviar();" rel="tooltip" data-title="Imprimir" class="btn btn-primary" role="button">
...
<script>
    function enviar() {
        window.open("/dasa_compras/informes/compras/presupuesto/presupuesto_print.php?vdesde=" + "'" + $('#iddesde').val() + "'" + "&vhasta=" + "'" + $('#idhasta').val() + "'" + "&vopcion=" + $('#opcion').val(), '_blank');
    }
</script>
<script>
//     function hasta() {
