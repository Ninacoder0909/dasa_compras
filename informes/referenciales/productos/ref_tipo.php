...
<form accept-charset="UTF8" class="form-horizontal">
    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
             <a href="#" class="list-group-item active" style="background-color: #ABD3D1;color: black">PRODUCTOS POR TIPO</a>
        </div>
        <div class="form-group col-md-12">
            <label class="col-sm-3 control-label">TIPOS</label>
            <div class="col-sm-6">
                <?php $consultas = consultas::get_datos("SELECT * FROM ref_tipo_producto ORDER BY id_tipro");?>
                <select class="form-control select2" name="vpag" id="vciudad" style="width: 215px;">
                    <?php
                    if (!empty($consultas)) {
                        foreach ($consultas as $c) { ?>
                    <option value="<?php echo $c['id_tipro'];?>"><?php echo $c['tipro_descri'];?>
                    </option>
                     <?php   }
                    } else { ?>
