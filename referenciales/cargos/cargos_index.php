                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="cargos_add.php" class="btn btn-success pull-right btn-sm" style="padding: 8px; margin: 1px">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                    <a href="cargos_print.php" class="btn btn-bitbucket pull-right btn-sm" style="padding: 8px; margin: 1px">
                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        ...
                                        //$cargos = consultas::get_datos("SELECT * FROM ref_cargos ORDER BY id_cargo");
                                        if (!empty($cargos)) {
                                        ?>
                                                ...
                                                <table class=" table col-lg-12 col-md-12 col-xs-12">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($cargos as $p) { ?>
                                                            <tr>
                                                                <td data-title="Nombre"> <?php echo $p['car_descri'] ?></td>
                                                                <td data-title="Acciones" class="text-center">
                                                                    <a href="cargos_edit.php?vid_cargos=<?php echo $p['id_cargo'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Editar" rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-edit"></span>
                                                                    </a>

                                                                    <a href="cargos_delete.php?vid_cargos=<?php echo $p['id_cargo'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Borrar" rel="tooltip" data-placement="top">
