                                            ...
                                            <input type="hidden" name="vidcodigo" value="<?php echo $resultado[0]['id_depo']; ?>">
                                             <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input type="text" class="form-control"  onkeypress="return soloLetras(event)" name="vdepdescri" autofocus="" required="" id="vmardescri" value="<?php echo $resultado[0]['dep_descri']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
