                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="empleado_add.php" class="btn btn-success pull-right btn-sm" style="padding: 8px; margin: 1px">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                    <a href="empleado_print.php" class="btn btn-bitbucket pull-right btn-sm" style="padding: 8px; margin: 1px">
                                        <i class="fa fa-print"></i>
                                    </a>
                                    <!--BUSCADOR-->
                                    <form action="empleado_index.php" method="POST" accept-charset="UTF-8" class="form-inline">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <?php if ($p['estado'] == 'ACTIVO') { ?>
                                                                        <a href="empleado_edit.php?vid_empleado=<?php echo $p['id_empleado'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Editar" rel="tooltip" data-placement="top">
                                                                            <span class="glyphicon glyphicon-edit"></span>
                                                                        </a>

                                                                        <a href="empleado_delete.php?vid_empleado=<?php echo $p['id_empleado'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Inhabilitar" rel="tooltip" data-placement="top">
