                                                        ...
                                                        <?php foreach ($marca as $p) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    <a href="marca_edit.php?vid_marca=<?php echo $p['mar_cod'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Editar" rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-edit"></span>
                                                                    </a>

                                                                    <a href="marca_delete.php?vid_marca=<?php echo $p['mar_cod'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Borrar" rel="tooltip" data-placement="top">
