                                ...
                                <form action="persona_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="vpernrodoc" value="<?php echo $resultado[0]['per_nro_doc']; ?>">
                                            <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Nombre</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" disabled="" value="<?php echo $resultado[0]['per_nombre']; ?>" name="vpernombre" required="" autofocus="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Apellido</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  disabled="" value="<?php echo $resultado[0]['per_apellido']; ?>" name="vperapellido" required="" autofocus="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  disabled="" value="<?php echo $resultado[0]['per_nro_doc']; ?>"  name="vpernrodoc" required="" autofocus="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >RUC</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  disabled=""  value="<?php echo $resultado[0]['per_ruc']; ?>"name="vperruc" required="" autofocus="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select3" name="vtipopercod" required="" disabled="" style="width: 320px;">  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control"  disabled="" type="text" value="<?php echo $resultado[0]['per_direccion']; ?>" name="vperdireccion" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control"  disabled="" type="text" value="<?php echo $resultado[0]['per_telefono']; ?>" name="vpertelefono" required="" min="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control"  disabled="" type="text" value="<?php echo $resultado[0]['per_email']; ?>" name="vperemail" required="" min="0">
                                                </div>
                                            </div>
                                            <div class = "form-group">
                                                <label class = "control-label  col-lg-3 col-sm-2 col-xs-2">Sexo</label>
                                                <div class = "col-lg-4 col-sm-4 col-xs-4">
                                                    <select class="form-control select3"  disabled="" name="vpersexo" value="<?php echo $resultado[0]['per_sexo']; ?>" required="" style="width: 150px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  disabled="" value="<?php echo $resultado[0]['per_fecha_nacimiento']; ?>" name="vperfechanacimiento" required="" min="0">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Razon social</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  disabled="" value="<?php echo $resultado[0]['razon_social']; ?>" name="vrazonsocial" required="" min="0">
                                                </div>
                                            </div>
                                            <!--Codigo imagen-->
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control"  disabled="" type="file" name="vperimagen" required="" min="0" placeholder="Seleccionne una imagen">
                                                </div>
                                            </div>
                                            <!--Fin Codigo imagen-->
                                        </div>
