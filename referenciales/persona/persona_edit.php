                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box_primary">
                                ...
                                <form action="persona_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                    <?php $resultado = consultas::get_datos("SELECT * FROM v_ref_persona WHERE id_persona =" . $_GET['vid_persona']); ?>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="vidcodigo" value="<?php echo $resultado[0]['id_persona']; ?>">
                                            <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Nombre</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return soloLetras(event)" value="<?php echo $resultado[0]['per_nombre']; ?>" name="vpernombre" required="" autofocus="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Apellido</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return soloLetras(event)" value="<?php echo $resultado[0]['per_apellido']; ?>" name="vperapellido" required="" autofocus="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return cedula(event)"  value="<?php echo $resultado[0]['per_nro_doc']; ?>"  name="vpernrodoc" required="" autofocus="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >RUC</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return soloNum(event)"  value="<?php echo $resultado[0]['per_ruc']; ?>"name="vperruc" required="" autofocus="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select3" name="vidciudad" required="" style="width: 320px;">  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="input-group">
                                                          <?php $marcas = consultas::get_datos("SELECT * FROM ref_tipo_persona where id_tipper !=" . $resultado[0]['tipo_per_cod']); ?>
                                                        <select class="form-control select3" name="vtipopercod" required="" style="width: 320px;">  
                                                            <option value="<?php echo $resultado[0]['tipo_per_cod']; ?>"><?php echo $resultado[0]['tp_descri']; ?></option>
                                                            <?php
                                                            if (!empty($marcas)) {
                                                                foreach ($marcas as $m) {
                                                                    ?>
                                                                    <option value="<?php echo $m['id_tipper']; ?>"><?php echo $m['tp_descri']; ?></option>
                                                                    <?php
                                                                }
                                                            } else {
                                                                ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return letraNum(event)" value="<?php echo $resultado[0]['per_direccion']; ?>" name="vperdireccion" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  onkeypress="return soloNum(event)" value="<?php echo $resultado[0]['per_telefono']; ?>" name="vpertelefono" required="" min="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control"  id="email"type="text" onkeypress="return cor(event)" value="<?php echo $resultado[0]['per_email']; ?>" name="vperemail" required="" min="0">
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <div class = "col-lg-4 col-sm-4 col-xs-4">
                                                    <select class="form-control select3" name="vpersexo" value="<?php echo $resultado[0]['per_sexo']; ?>" required="" style="width: 150px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return fnac(event)" value="<?php echo $resultado[0]['per_fecha_nacimiento']; ?>" name="vperfechanacimiento" required="" min="0">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Razon social</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" onkeypress="return soloLetras(event)"  value="<?php echo $resultado[0]['razon_social']; ?>" name="vrazonsocial" required="" min="0">
                                                </div>
                                            </div>
                                            <!--Codigo imagen-->
                                            <div class="form-group">
