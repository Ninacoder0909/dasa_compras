                                                        ...
                                                        <?php foreach ($proveedor as $p) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    <a href="proveedor_edit.php?vid_proveedor=<?php echo $p['prv_cod'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Editar" rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-edit"></span>
                                                                    </a>

                                                                    <a href="proveedor_delete.php?vid_proveedor=<?php echo $p['prv_cod'] ?>" class="btn btn-toolbar btn-lg" role="button" data-title="Borrar" rel="tooltip" data-placement="top">
