...
$pdf->Ln();
$pdf->Cell(50, 5,"           Nombre", 1, 'C',1);
$pdf->Cell(45, 5,"         Ciudad", 1, 'C',1);
$pdf->Cell(25, 5,"     RUC", 1, 'C',1);
$pdf->Cell(50, 5,"        Direccion", 1, 'C',1);
$pdf->Cell(28, 5,"    Telefono", 1, 'C',1);
//Salto de linea 
$pdf->Ln();
//tabla
...
foreach ($sqls AS $sql){
    ...
    $pdf->Cell(45, 5, $sql['ciu_descri'], 1, 0, 'C',1);
    $pdf->Cell(25, 5, $sql['prv_ruc'], 1, 0, 'C',1);
    $pdf->Cell(50, 5, $sql['prv_direccion'], 1, 0, 'C',1);
    $pdf->Cell(28, 5, $sql['prv_tel'], 1, 0, 'C',1);
    $pdf->Ln();
}
//Salida al navegador
