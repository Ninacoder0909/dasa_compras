...
$sqls = consultas::get_datos("SELECT * FROM v_ref_sucusal ORDER BY id_sucursal");
foreach ($sqls AS $sql){
    $pdf->Cell(35, 5, $sql['id_sucursal'], 1, 0, 'C',1);
    $pdf->Cell(55, 5, $sql['ciu_descri'], 1, 0, 'C',1);
    $pdf->Cell(40, 5, $sql['suc_telefono'], 1, 0, 'C',1);
    $pdf->Cell(60, 5, $sql['suc_direccion'], 1, 0, 'C',1);
    $pdf->Ln();
}
//Salida al navegador
