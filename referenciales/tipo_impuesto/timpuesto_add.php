                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Agregar Tipo de Impuesto</h3>
                                <div class="box-tools">
                            ...
                            <form action="timpuesto_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="vidtimpuesto" value="0" />
                                        <div class="form-group">
                                            <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Descripcion</label>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <input class="form-control" type="text" onkeypress="return soloLetras(event)" autofocus="" name="vdescri" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Porcentaje</label>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <input class="form-control" type="number" onkeypress="return soloNumeros(event)" name="vporcen" required="" min="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
