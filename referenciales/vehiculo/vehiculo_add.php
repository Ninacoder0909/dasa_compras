                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" name="vdescripcion" onkeypress="return soloLetras(event)" required="" autofocus="" />
                                                </div>
                                            </div>
                                              <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Nro Chapa</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  onkeypress="return soloNum(event)" name="vnro_chasis" required="" autofocus="" >
                                                </div>
                                            </div>
                                        </div>
