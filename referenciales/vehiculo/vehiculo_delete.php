                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Borrar Vehiculo</h3>
                                    <div class="box-tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text" name="vdescripcion" onkeypress="return soloLetras(event)"  required="" disabled="" value="<?php echo $resultado[0]['descri']; ?>">
                                                </div>
                                            </div>
                                              <div class="form-group">
                                                <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Nro Chapa</label>
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <input class="form-control" type="text"  onkeypress="return soloNum(event)" name="vnro_chasis" required="" disabled="" value="<?php echo $resultado[0]['nro_chasis']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
